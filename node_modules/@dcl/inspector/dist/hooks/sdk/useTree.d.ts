...
export declare const useTree: () => {
    ...
    setParent: (source: Entity, target: Entity, type: DropType) => Promise<void>;
    rename: (entity: Entity, value: string) => Promise<void>;
    remove: (entity: Entity) => Promise<void>;
    select: (entity: Entity, multiple?: boolean) => Promise<void>;
    duplicate: (entity: Entity, preferredGizmo?: GizmoType) => Promise<void>;
    ...
    canDrag: (entity: Entity) => boolean;
    canReorder: (source: Entity, target: Entity, type: DropType) => boolean;
    centerViewOnEntity: (entity: Entity) => void;
    getSelectedItems: () => Entity[];
};
