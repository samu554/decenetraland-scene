...
export declare const useComponentValue: <ComponentValueType>(entity: Entity, component: Component<ComponentValueType>, normalizeForComparison?: (value: ComponentValueType) => ComponentValueType, tolerance?: number) => readonly [ComponentValueType, import("react").Dispatch<import("react").SetStateAction<ComponentValueType>>, (val: ComponentValueType) => boolean];
