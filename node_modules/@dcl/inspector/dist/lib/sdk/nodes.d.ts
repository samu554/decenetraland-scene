...
export declare function pushChildToNodes(nodes: readonly Node[], parent: Entity, child: Entity): Node[];
export declare function insertChildAfterInNodes(nodes: readonly Node[], parent: Entity, child: Entity, afterEntity: Entity): Node[];
