...
export declare namespace PeerMessageData {
    function encode(message: PeerMessageData, writer?: _m0.Writer): _m0.Writer;
    function decode(input: _m0.Reader | Uint8Array, length?: number): PeerMessageData;
    function fromJSON(object: any): PeerMessageData;
    function toJSON(message: PeerMessageData): unknown;
    function create<I extends Exact<DeepPartial<PeerMessageData>, I>>(base?: I): PeerMessageData;
    function fromPartial<I extends Exact<DeepPartial<PeerMessageData>, I>>(object: I): PeerMessageData;
}
