...
exports.CommunicationsControllerServiceDefinition = exports.SendBinaryResponse = exports.PeerMessageData = exports.SendBinaryRequest = exports.RealSendResponse = exports.RealSendRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
(function (SendBinaryRequest) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.peerData) {
            PeerMessageData.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.peerData.push(PeerMessageData.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    function fromJSON(object) {
        return {
            ...
            peerData: Array.isArray(object === null || object === void 0 ? void 0 : object.peerData) ? object.peerData.map((e) => PeerMessageData.fromJSON(e)) : [],
        };
    }
    ...
    function toJSON(message) {
        ...
        if (message.peerData) {
            obj.peerData = message.peerData.map((e) => e ? PeerMessageData.toJSON(e) : undefined);
        }
        else {
            obj.peerData = [];
        }
    ...
    function fromPartial(object) {
        ...
        message.peerData = ((_b = object.peerData) === null || _b === void 0 ? void 0 : _b.map((e) => PeerMessageData.fromPartial(e))) || [];
        return message;
    }
    SendBinaryRequest.fromPartial = fromPartial;
})(SendBinaryRequest || (exports.SendBinaryRequest = SendBinaryRequest = {}));
function createBasePeerMessageData() {
    return { data: [], address: [] };
}
var PeerMessageData;
(function (PeerMessageData) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.data) {
            writer.uint32(10).bytes(v);
        }
    ...
    PeerMessageData.encode = encode;
    function decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBasePeerMessageData();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    PeerMessageData.fromJSON = fromJSON;
    function toJSON(message) {
        const obj = {};
        if (message.data) {
            obj.data = message.data.map((e) => base64FromBytes(e !== undefined ? e : new Uint8Array(0)));
    ...
    PeerMessageData.toJSON = toJSON;
    function create(base) {
        return PeerMessageData.fromPartial(base !== null && base !== void 0 ? base : {});
    }
    PeerMessageData.create = create;
    function fromPartial(object) {
        var _a, _b;
        const message = createBasePeerMessageData();
        message.data = ((_a = object.data) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
        message.address = ((_b = object.address) === null || _b === void 0 ? void 0 : _b.map((e) => e)) || [];
        return message;
    }
    PeerMessageData.fromPartial = fromPartial;
})(PeerMessageData || (exports.PeerMessageData = PeerMessageData = {}));
