...
export declare namespace PBVisibilityComponent {
    ...
    function fromJSON(object: any): PBVisibilityComponent;
    function toJSON(message: PBVisibilityComponent): unknown;
    function create<I extends Exact<DeepPartial<PBVisibilityComponent>, I>>(base?: I): PBVisibilityComponent;
    function fromPartial<I extends Exact<DeepPartial<PBVisibilityComponent>, I>>(object: I): PBVisibilityComponent;
}
