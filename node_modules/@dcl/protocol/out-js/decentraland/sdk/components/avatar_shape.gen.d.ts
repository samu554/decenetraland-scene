...
export declare namespace PBAvatarShape {
    ...
    function fromJSON(object: any): PBAvatarShape;
    function toJSON(message: PBAvatarShape): unknown;
    function create<I extends Exact<DeepPartial<PBAvatarShape>, I>>(base?: I): PBAvatarShape;
    function fromPartial<I extends Exact<DeepPartial<PBAvatarShape>, I>>(object: I): PBAvatarShape;
}
