...
export namespace SendBinaryRequest {
  ...
  export function fromJSON(object: any): SendBinaryRequest {
    return {
      ...
      peerData: Array.isArray(object?.peerData) ? object.peerData.map((e: any) => PeerMessageData.fromJSON(e)) : [],
    };
  }
  ...
  export function fromPartial<I extends Exact<DeepPartial<SendBinaryRequest>, I>>(object: I): SendBinaryRequest {
    ...
    message.peerData = object.peerData?.map((e) => PeerMessageData.fromPartial(e)) || [];
    return message;
  }
}

function createBasePeerMessageData(): PeerMessageData {
  return { data: [], address: [] };
}

export namespace PeerMessageData {
  export function encode(message: PeerMessageData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.data) {
      writer.uint32(10).bytes(v!);
    }
  ...
  export function decode(input: _m0.Reader | Uint8Array, length?: number): PeerMessageData {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  export function fromJSON(object: any): PeerMessageData {
    return {
      data: Array.isArray(object?.data) ? object.data.map((e: any) => bytesFromBase64(e)) : [],
  ...
  export function toJSON(message: PeerMessageData): unknown {
    const obj: any = {};
    if (message.data) {
      obj.data = message.data.map((e) => base64FromBytes(e !== undefined ? e : new Uint8Array(0)));
    } else {
  ...
  export function create<I extends Exact<DeepPartial<PeerMessageData>, I>>(base?: I): PeerMessageData {
    return PeerMessageData.fromPartial(base ?? {});
  }

  export function fromPartial<I extends Exact<DeepPartial<PeerMessageData>, I>>(object: I): PeerMessageData {
    const message = createBasePeerMessageData();
    message.data = object.data?.map((e) => e) || [];
