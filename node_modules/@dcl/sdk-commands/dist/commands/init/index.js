...
async function main(options) {
    ...
    if (!isEmpty && !yes) {
        throw new error_1.CliError('INIT_DIR_NOT_EMPTY', i18next_1.default.t('errors.init.dir_not_empty'));
    }
    if (requestedTemplateZipUrl && requestedProjectTemplate) {
        throw new error_1.CliError('INIT_INVALID_ARGUMENTS', i18next_1.default.t('errors.init.invalid_arguments'));
    }
    if (requestedProjectTemplate && !(0, repos_1.existScaffoldedProject)(requestedProjectTemplate)) {
        throw new error_1.CliError('INIT_INVALID_PROJECT', i18next_1.default.t('errors.init.invalid_project', { options: (0, repos_1.scaffoldedProjectOptions)().join(', ') }));
    }
...
async function downloadAndUnzipUrlContainFolder(url, dest, options) {
    ...
    if (zipExtracted.topLevelFolders.length !== 1) {
        throw new error_1.CliError('INIT_INVALID_TEMPLATE_ZIP_URL', i18next_1.default.t('errors.init.invalid_template_zip_url'));
    }
