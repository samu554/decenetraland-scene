...
const buffer_validator_1 = require("./buffer-validator");
const buffer_view_validator_1 = require("./buffer-view-validator");
const accessor_validator_1 = require("./accessor-validator");
const animation_validator_1 = require("./animation-validator");
const node_validator_1 = require("./node-validator");
const mesh_validator_1 = require("./mesh-validator");
const material_validator_1 = require("./material-validator");
const texture_validator_1 = require("./texture-validator");
const image_validator_1 = require("./image-validator");
const sampler_validator_1 = require("./sampler-validator");
const camera_validator_1 = require("./camera-validator");
const scene_validator_1 = require("./scene-validator");
const skin_validator_1 = require("./skin-validator");
const usage_tracker_1 = require("../usage-tracker");
const extensions_1 = require("./extensions");
class GLTFValidator {
    constructor(options = {}) {
        this.messages = [];
        this.bufferData = new Map();
        this.options = {
    ...
    validateAsset(gltf) {
        ...
        const validator = new asset_validator_1.AssetValidator();
    ...
    validateBuffers(gltf) {
        ...
        if (gltf._explicitlyDefined?.buffers &&
        ...
        const validator = new buffer_validator_1.BufferValidator();
    ...
    validateBufferViews(gltf) {
        ...
        if (gltf._explicitlyDefined?.bufferViews &&
        ...
        const validator = new buffer_view_validator_1.BufferViewValidator();
    ...
    validateAccessors(gltf) {
        ...
        if (gltf._explicitlyDefined?.accessors &&
        ...
        const validator = new accessor_validator_1.AccessorValidator();
        const allMessages = [];
    ...
    validateAnimations(gltf) {
        ...
        if (gltf._explicitlyDefined?.animations &&
        ...
        const validator = new animation_validator_1.AnimationValidator();
        const allMessages = [];
                        ...
                        if (sampler &&
                            ...
                            if (inputAccessor &&
                                ...
                                if (bufferView && bufferView.buffer !== undefined) {
                                    const bufferData = this.getBufferData(bufferView.buffer);
                                    if (bufferData) {
                                        const inputValidator = new accessor_validator_1.AccessorValidator();
                            ...
                            if (outputAccessor &&
                                ...
                                if (bufferView && bufferView.buffer !== undefined) {
                                    const bufferData = this.getBufferData(bufferView.buffer);
                                    if (bufferData) {
                                        const outputValidator = new accessor_validator_1.AccessorValidator();
    ...
    validateNodes(gltf) {
        ...
        if (gltf._explicitlyDefined?.nodes &&
            gltf.nodes.length === 0) {
            this.addMessage({
                code: "EMPTY_ENTITY",
                message: "Entity cannot be empty.",
        ...
        const validator = new node_validator_1.NodeValidator();
    ...
    validateMeshes(gltf) {
        ...
        if (gltf._explicitlyDefined?.meshes &&
        ...
        const validator = new mesh_validator_1.MeshValidator();
                                    ...
                                    if (typeof accessorIndex === "number" && gltf.accessors) {
                                        ...
                                        if (accessor &&
                                            ...
                                            if (bufferView && bufferView.buffer !== undefined) {
                                                const bufferData = this.getBufferData(bufferView.buffer);
                                                if (bufferData) {
                                                    const accessorValidator = new accessor_validator_1.AccessorValidator();
    ...
    validateMaterials(gltf) {
        ...
        if (gltf._explicitlyDefined?.materials &&
        ...
        const validator = new material_validator_1.MaterialValidator();
    ...
    validateTextures(gltf) {
        ...
        if (gltf._explicitlyDefined?.textures &&
        ...
        const validator = new texture_validator_1.TextureValidator();
    ...
    async validateImages(gltf) {
        ...
        if (gltf._explicitlyDefined?.images &&
        ...
        const validator = new image_validator_1.ImageValidator(this.options.externalResourceFunction);
    ...
    validateSamplers(gltf) {
        ...
        if (gltf._explicitlyDefined?.samplers &&
        ...
        const validator = new sampler_validator_1.SamplerValidator();
    ...
    validateCameras(gltf) {
        ...
        if (gltf._explicitlyDefined?.cameras &&
        ...
        const validator = new camera_validator_1.CameraValidator();
    ...
    validateScenes(gltf) {
        ...
        if (gltf._explicitlyDefined?.scenes &&
        ...
        const validator = new scene_validator_1.SceneValidator();
    ...
    validateSkins(gltf) {
        ...
        if (gltf._explicitlyDefined?.skins &&
            gltf.skins.length === 0) {
            this.addMessage({
                code: "EMPTY_ENTITY",
                message: "Entity cannot be empty.",
        ...
        const validator = new skin_validator_1.SkinValidator();
    ...
    validateSkinnedMeshNodeHierarchy(gltf) {
        ...
        for (let nodeIndex = 0; nodeIndex < gltf.nodes.length; nodeIndex++) {
            const node = gltf.nodes[nodeIndex];
            if (!node || node.skin === undefined || node.mesh === undefined)
                continue;
    ...
    validateExtensions(gltf) {
        ...
        if (gltf["extensionsUsed"]) {
            for (const extensionName of gltf["extensionsUsed"]) {
                const validator = extensions_1.extensionValidators.get(extensionName);
                if (validator) {
        ...
        if (gltf["extensionsUsed"]) {
            ...
            for (let i = 0; i < extensionsUsedArray.length; i++) {
                ...
                if (!this.isExtensionUsed(gltf, extension) &&
            ...
            for (const material of gltf.materials) {
                ...
                if (material && material.pbrMetallicRoughness) {
                    if (material.pbrMetallicRoughness.baseColorTexture &&
                        ...
                        material.pbrMetallicRoughness.baseColorTexture["extensions"][extensionName]) {
                        return true;
                    }
                    if (material.pbrMetallicRoughness.metallicRoughnessTexture &&
                        material.pbrMetallicRoughness.metallicRoughnessTexture["extensions"] &&
                        material.pbrMetallicRoughness.metallicRoughnessTexture["extensions"][extensionName]) {
                        return true;
                    }
                }
                if (material &&
    ...
    sortMessagesForTestCompatibility() {
        ...
        this.messages.sort((a, b) => {
            ...
            if (a.code === "UNUSED_OBJECT" &&
                b.code === "BUFFER_GLB_CHUNK_TOO_BIG" &&
                a.pointer === b.pointer) {
                return -1;
            }
            if (a.code === "BUFFER_GLB_CHUNK_TOO_BIG" &&
            ...
            if (a.code === "IMAGE_UNRECOGNIZED_FORMAT" &&
                b.code === "UNUSED_OBJECT" &&
                a.pointer === b.pointer) {
                return 1;
            }
            ...
            if (a.code === "IMAGE_UNEXPECTED_EOS" &&
                b.code === "UNUSED_OBJECT" &&
                a.pointer === b.pointer) {
                return 1;
            }
            ...
            if (a.code === "ACCESSOR_INDEX_PRIMITIVE_RESTART" &&
                b.code === "UNUSED_OBJECT" &&
                a.pointer &&
                b.pointer &&
                a.pointer.startsWith(b.pointer + "/")) {
            ...
            if (a.code === "ACCESSOR_NON_CLAMPED" &&
                b.code === "UNUSED_OBJECT" &&
                a.pointer &&
                b.pointer &&
                a.pointer.startsWith(b.pointer + "/")) {
            ...
            if ((a.code === "ACCESSOR_JOINTS_INDEX_OOB" ||
            ...
            if (a.code === "ACCESSOR_INDEX_TRIANGLE_DEGENERATE" &&
                b.code === "UNUSED_OBJECT" &&
                a.pointer &&
                b.pointer &&
                a.pointer.startsWith(b.pointer + "/")) {
            ...
            if (a.code === "MESH_PRIMITIVES_UNEQUAL_TARGETS_COUNT" &&
                b.code === "UNUSED_OBJECT" &&
                a.pointer &&
                b.pointer &&
                a.pointer.startsWith(b.pointer + "/")) {
            ...
            if (a.code === "IMAGE_MIME_TYPE_INVALID" &&
                b.code === "UNUSED_OBJECT" &&
                b.pointer &&
                a.pointer &&
                a.pointer.startsWith(b.pointer + "/")) {
            ...
            if (a.code === "TEXTURE_INVALID_IMAGE_MIME_TYPE" &&
                b.code === "UNUSED_OBJECT") {
                // Check if both relate to the same texture object
                const aTexture = a.pointer?.match(/\/textures\/(\d+)\//);
                const bTexture = b.pointer?.match(/\/textures\/(\d+)$/);
            ...
            if (a.code === "IMAGE_NPOT_DIMENSIONS" &&
                b.code === "UNUSED_OBJECT" &&
                a.pointer === b.pointer) {
                return 1;
            }
            ...
            if (a.code === "MESH_PRIMITIVE_INVALID_ATTRIBUTE" &&
                b.code === "MESH_PRIMITIVE_MORPH_TARGET_NO_BASE_ACCESSOR") {
                return -1;
            }
            if (a.code === "MESH_PRIMITIVE_MORPH_TARGET_NO_BASE_ACCESSOR" &&
            ...
            if (a.code === "MESH_PRIMITIVE_TANGENT_WITHOUT_NORMAL" &&
                b.code === "MESH_PRIMITIVE_GENERATED_TANGENT_SPACE") {
                return -1;
            }
            if (a.code === "MESH_PRIMITIVE_GENERATED_TANGENT_SPACE" &&
            ...
            if (a.code === "BUFFER_BYTE_LENGTH_MISMATCH" &&
            ...
            if (a.severity !== b.severity) {
                ...
                if (aIsImage && bIsImage) {
                    ...
                    if (a.code === "IMAGE_NON_ENABLED_MIME_TYPE" &&
                        b.code === "UNUSED_OBJECT") {
                        return 1;
                    }
                ...
                if (aIsMeshPrimitive && bIsMeshPrimitive) {
                    ...
                    if (aBasePath && bBasePath && aBasePath[1] === bBasePath[1]) {
                        ...
                        if (aIsAttribute && bIsIndices)
                            return -1; // attributes before indices
                ...
                if (a.pointer === b.pointer) {
                    if (a.code === "BUFFER_VIEW_TARGET_MISSING" &&
                        b.code === "MESH_PRIMITIVE_INDICES_ACCESSOR_WITH_BYTESTRIDE") {
                        return -1;
                    }
                    if (a.code === "MESH_PRIMITIVE_INDICES_ACCESSOR_WITH_BYTESTRIDE" &&
            ...
            if (aIsAccessor && bIsAccessor) {
                ...
                if (a.code === "ACCESSOR_INVALID_FLOAT" ||
                    ...
                    if (b.code === "ACCESSOR_INVALID_FLOAT" &&
