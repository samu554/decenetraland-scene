...
exports.AnimationValidator = void 0;
...
class AnimationValidator {
    ...
    validateChannel(channel, animationIndex, channelIndex, gltf) {
        ...
        else if (!gltf.animations?.[animationIndex]?.samplers ||
        ...
        if (!channel.target) {
            ...
            if (channel.target.node !== undefined && channel.target.path) {
                ...
                if (channel.target.path === "weights") {
                    ...
                    if (!mesh ||
                        !mesh.primitives ||
                        mesh.primitives.every((primitive) => !primitive.targets || primitive.targets.length === 0)) {
                        messages.push({
    ...
    validateTarget(target, animationIndex, channelIndex, gltf, channel) {
        ...
        else if (!Object.values(types_1.AnimationPath).includes(target.path)) {
            // Allow "pointer" path when KHR_animation_pointer extension is used (in target or channel)
            const hasAnimationPointerExt = (target.extensions && target.extensions["KHR_animation_pointer"]) ||
                (channel &&
                    channel["extensions"] &&
    ...
    validateSampler(sampler, animationIndex, samplerIndex, gltf) {
                ...
                if (expectedFormat &&
                    ...
                    if (gltf.animations?.[animationIndex]?.channels) {
                        for (let i = 0; i < gltf.animations[animationIndex].channels.length; i++) {
                            if (gltf.animations[animationIndex].channels[i]?.sampler ===
                                samplerIndex) {
                                channelIndex = i;
                                break;
                            }
        ...
        if (sampler.interpolation !== undefined) {
            ...
            else if (!Object.values(types_1.AnimationInterpolation).includes(sampler.interpolation)) {
                messages.push({
                    code: "INVALID_VALUE",
...
exports.AnimationValidator = AnimationValidator;
//# sourceMappingURL=animation-validator.js.map