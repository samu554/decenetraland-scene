...
class MaterialValidator {
    validate(material, index, gltf) {
        ...
        if (material.alphaMode !== undefined) {
            ...
            else if (!Object.values(types_1.AlphaMode).includes(material.alphaMode)) {
                messages.push({
                    code: "INVALID_VALUE",
        ...
        if (material.pbrMetallicRoughness) {
            ...
            if (material.pbrMetallicRoughness.baseColorTexture) {
                ...
                if (material.pbrMetallicRoughness.baseColorTexture["extensions"] &&
            ...
            if (material.pbrMetallicRoughness.metallicRoughnessTexture) {
                const expectedTextureProperties = ["index", "texCoord"];
                // Allow extensions when KHR_texture_transform is used
                if (material.pbrMetallicRoughness.metallicRoughnessTexture["extensions"] &&
        ...
        if (material.normalTexture) {
            ...
            // Allow extensions when KHR_texture_transform is used
            if (material.normalTexture["extensions"] &&
        ...
        if (material.occlusionTexture) {
            ...
            // Allow extensions when KHR_texture_transform is used
            if (material.occlusionTexture["extensions"] &&
        ...
        if (material.emissiveTexture) {
            ...
            // Allow extensions when KHR_texture_transform is used
            if (material.emissiveTexture["extensions"] &&
        ...
        if (material["extensions"]) {
            ...
            if (extensions.includes("KHR_materials_unlit")) {
                const incompatibleWithUnlit = extensions.filter((ext) => ext !== "KHR_materials_unlit" &&
            ...
            if (extensions.includes("KHR_materials_pbrSpecularGlossiness")) {
                const incompatibleWithPbrSG = extensions.filter((ext) => ext !== "KHR_materials_pbrSpecularGlossiness" &&
