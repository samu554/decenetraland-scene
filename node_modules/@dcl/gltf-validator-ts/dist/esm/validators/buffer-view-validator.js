...
export class BufferViewValidator {
    validate(bufferView, index, gltf) {
        ...
        else if (typeof bufferView.byteLength !== "number" ||
        ...
        if (bufferView.byteOffset !== undefined) {
            if (typeof bufferView.byteOffset !== "number" ||
        ...
        if (bufferView.byteStride !== undefined) {
            if (typeof bufferView.byteStride !== "number" ||
            ...
            else if (bufferView.byteLength !== undefined &&
                bufferView.byteStride > bufferView.byteLength) {
                messages.push({
            ...
            else if (bufferView.target !== undefined &&
        ...
        if (bufferView.buffer !== undefined &&
            ...
            if (buffer &&
                bufferViewOffset + bufferView.byteLength > buffer.byteLength) {
...
//# sourceMappingURL=buffer-view-validator.js.map