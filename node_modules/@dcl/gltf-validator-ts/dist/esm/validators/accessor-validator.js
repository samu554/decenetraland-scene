import { Severity, ComponentType, AccessorType, } from "../types";
export class AccessorValidator {
    validate(accessor, index, gltf) {
        ...
        if (accessor.byteOffset !== undefined) {
            ...
            else if (typeof accessor.byteOffset !== "number" ||
    ...
    validateJointsData(accessor, _index, gltf, bufferData, attributeName, meshIndex, primitiveIndex) {
        ...
        for (const [attrName, accessorIdx] of Object.entries(primitive.attributes)) {
            ...
            else if (attrName.startsWith("WEIGHTS_") &&
        ...
        if (weightsAccessorIndex !== undefined && gltf.accessors) {
            ...
            if (weightsAcc &&
                ...
                if (weightsBufferView) {
                    ...
                    const weightsSize = weightsAcc.count *
        ...
        for (let i = 0; i < accessor.count; i++) {
            ...
            for (let component = 0; component < typeComponentCount; component++) {
                    ...
                    if (typeof jointsAccessorIdx === "number" && gltf.accessors) {
                        ...
                        if (jointsAcc &&
                            ...
                            if (jointsBV) {
                                ...
                                const jointsElementSize = jointsBV.byteStride ||
                                ...
                                for (let comp = 0; comp < this.getTypeComponentCount(jointsAcc.type); comp++) {
                                    const jointsCompOffset = jointsElementOffset +
                ...
                if (vertexJoints.filter((j) => j === jointIndex).length > 1 &&
                    jointIndex !== 0) {
                ...
                if (weightsData &&
                    ...
                    const weightElementSize = weightsBV?.byteStride ||
                        this.getComponentSize(weightsAcc.componentType) *
                            this.getTypeComponentCount(weightsAcc.type);
                    const weightElementOffset = i * weightElementSize;
                    const weightComponentOffset = weightElementOffset +
                    ...
                    switch (weightsAcc.componentType) {
                        ...
                        case 5123: // UNSIGNED_SHORT normalized
                            weight =
                                new DataView(weightsData.buffer, weightsData.byteOffset + weightComponentOffset).getUint16(0, true) / 65535.0;
                            break;
                    }
    ...
    validateWeightsData(accessor, _index, gltf, bufferData, attributeName, meshIndex, primitiveIndex) {
        ...
        for (let i = 0; i < accessor.count; i++) {
            ...
            if (elementOffset + componentSize * typeComponentCount >
                bufferData.length) {
            ...
            for (let component = 0; component < typeComponentCount; component++) {
                ...
                switch (accessor.componentType) {
                    ...
                    case 5123: // UNSIGNED_SHORT normalized
                        weight =
                            new DataView(bufferData.buffer, bufferData.byteOffset + componentOffset).getUint16(0, true) / 65535.0;
                        break;
                    default:
                        continue; // Skip unsupported component types
                }
            ...
            for (let comp = 0; comp < typeComponentCount; comp++) {
                ...
                switch (accessor.componentType) {
                    ...
                    case 5123: // UNSIGNED_SHORT normalized
                        weightVal =
                            new DataView(bufferData.buffer, bufferData.byteOffset + compOffset).getUint16(0, true) / 65535.0;
                        break;
                    default:
                        continue;
                }
    ...
    validateIBMMatrixConstraints(accessor, data, index, messages, skinIndex) {
        ...
        for (let matrixIndex = 0; matrixIndex < matrixCount; matrixIndex++) {
            ...
            if (elem3 !== 0.0) {
                ...
                const pointer = skinIndex !== undefined
...
//# sourceMappingURL=accessor-validator.js.map