...
export class ImageValidator {
                        ...
                        if (!mimeType || !mimeType.startsWith("image/")) {
                            ...
                            try {
                                ...
                                if (decodedData.length >= 8) {
                                    ...
                                    else if (header.startsWith("GIF87a") ||
            ...
            try {
                ...
                if (!detectedFormat) {
                    ...
                    if (dimensions) {
                        ...
                        if (!isPowerOfTwo(dimensions.width) ||
    ...
    getPNGDimensions(data) {
        ...
        if (data.length < 33)
            return null; // 8 signature + 4 length + 4 type + 13 IHDR data + 4 CRC
        ...
        const width = (data[offset] << 24) |
            (data[offset + 1] << 16) |
            (data[offset + 2] << 8) |
            data[offset + 3];
        const height = (data[offset + 4] << 24) |
            (data[offset + 5] << 16) |
            (data[offset + 6] << 8) |
            data[offset + 7];
        return { width, height };
