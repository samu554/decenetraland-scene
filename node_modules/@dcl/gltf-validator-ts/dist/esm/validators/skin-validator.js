...
export class SkinValidator {
    validate(skin, index, gltf) {
        ...
        if (skin.inverseBindMatrices !== undefined) {
            if (typeof skin.inverseBindMatrices !== "number" ||
                ...
                skin.inverseBindMatrices >= gltf.accessors.length) {
                messages.push({
                    code: "UNRESOLVED_REFERENCE",
                ...
                if (ibmAccessor) {
                    ...
                    if (ibmAccessor.type !== "MAT4" ||
                        ibmAccessor.componentType !== 5126) {
                    ...
                    if (skin.joints &&
                        ...
                        ibmAccessor.count < skin.joints.length) {
                        messages.push({
    ...
    checkCommonRoot(joints, gltf) {
        ...
        if (joints.length === 1) {
            ...
            return (jointIndex !== undefined &&
                jointIndex >= 0 &&
                jointIndex < gltf.nodes.length);
        }
...
//# sourceMappingURL=skin-validator.js.map