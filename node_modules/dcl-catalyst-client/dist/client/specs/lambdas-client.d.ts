export type GetParcelOperators400 = {
    error?: string;
};
...
export type GetParcelPermissions400 = {
    error?: string;
};
...
export type ProfileAvatarsItemNameColor = {
    b: number;
    g: number;
    r: number;
};
...
export type ProfileAvatarsItemAvatarEmotesItem = {
    slot?: number;
    urn?: string;
};
export type ProfileAvatarsItemAvatar = {
    bodyShape?: string;
    emotes?: ProfileAvatarsItemAvatarEmotesItem[];
...
export interface ParcelOperators {
    address: string;
...
export interface ParcelPermissions {
    address: boolean;
...
export type AboutConfigurationsMapThumbnailViewTopLeftOffset = {
    x?: number;
    y?: number;
};
export type AboutConfigurationsMapThumbnailView = {
    baseUrl?: string;
    suffixUrl?: string;
    topLeftOffset?: AboutConfigurationsMapThumbnailViewTopLeftOffset;
    version: string;
};
export type AboutConfigurationsMapSizesItem = {
    bottom?: number;
    left?: number;
    right?: number;
    top?: number;
};
export type AboutConfigurationsMapSatelliteViewTopLeftOffset = {
    x?: number;
    y?: number;
};
export type AboutConfigurationsMapSatelliteView = {
    baseUrl?: string;
    suffixUrl?: string;
    topLeftOffset?: AboutConfigurationsMapSatelliteViewTopLeftOffset;
    version: string;
};
export type AboutConfigurationsMapParcelView = {
    imageUrl?: string;
    version: string;
};
export type AboutConfigurationsMap = {
    minimapEnabled: boolean;
    parcelView?: AboutConfigurationsMapParcelView;
    satelliteView?: AboutConfigurationsMapSatelliteView;
    sizes: AboutConfigurationsMapSizesItem[];
    thumbnailView?: AboutConfigurationsMapThumbnailView;
};
 ...
 */
export declare const getParcelPermissions: (address: string, x: string, y: string) => import("../utils/fetcher").CustomClient<ParcelPermissions>;
/**
 ...
 */
export declare const getParcelOperators: (x: string, y: string) => import("../utils/fetcher").CustomClient<ParcelOperators>;
/**
...
export type GetParcelPermissionsResult = NonNullable<Awaited<ReturnType<typeof getParcelPermissions>>>;
...
export type GetParcelOperatorsResult = NonNullable<Awaited<ReturnType<typeof getParcelOperators>>>;
