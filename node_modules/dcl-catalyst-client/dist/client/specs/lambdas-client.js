...
exports.getThirdPartyIntegrations = exports.getOutfits = exports.getAvatarDetails = exports.getAvatarsDetailsByPost = exports.getParcelOperators = exports.getRealms = exports.getHotScenes = exports.validateSignature = exports.getDenylistedUserNames = exports.getPois = exports.getCatalystServers = exports.searchWearables = exports.getThirdPartyCollection = exports.getThirdPartyWearables = exports.getParcelPermissions = exports.getLands = exports.getNames = exports.getEmotes = exports.getWearables = exports.getStandardErc721 = exports.getImage = exports.getThumbnail = exports.getCollections = exports.getLambdaStatus = void 0;
/**
 ...
 */
const getParcelPermissions = (address, x, y) => {
    return (0, fetcher_1.useCustomClient)({
        url: `/lambdas/users/${address}/parcels/${x}/${y}/permissions`,
        method: 'get'
    });
};
exports.getParcelPermissions = getParcelPermissions;
/**
 ...
 */
const getParcelOperators = (x, y) => {
    return (0, fetcher_1.useCustomClient)({ url: `/lambdas/parcels/${x}/${y}/operators`, method: 'get' });
};
exports.getParcelOperators = getParcelOperators;
/**
