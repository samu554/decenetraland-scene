...
export declare function getPortrait(): string;
export declare function getImage(): string;
...
export declare function addLineBreak(text: string, bubble?: boolean, fontSize?: number): string;
